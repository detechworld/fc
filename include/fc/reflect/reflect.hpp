...
#define FC_REFLECT_BASE_MEMBER_COUNT(r, OP, elem) OP fc::reflector<elem>::total_member_count
...
#define FC_REFLECT_DERIVED_IMPL_EXT(TYPE, INHERITS, MEMBERS)                                                           \
    template <typename Visitor> void fc::reflector<TYPE>::visit(const Visitor& v)                                      \
    {                                                                                                                  \
        BOOST_PP_SEQ_FOR_EACH(FC_REFLECT_VISIT_BASE, v, INHERITS)                                                      \
        BOOST_PP_SEQ_FOR_EACH(FC_REFLECT_VISIT_MEMBER, v, MEMBERS)                                                     \
    }
...
#define FC_REFLECT_ENUM(ENUM, FIELDS)                                                                                  \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            return BOOST_PP_STRINGIZE(ENUM);                                                                           \
        }                                                                                                              \
    };                                                                                                                 \
    }
...
#define FC_REFLECT_DERIVED_IMPL(TYPE, MEMBERS) FC_REFLECT_IMPL_DERIVED_EXT(TYPE, BOOST_PP_SEQ_NIL, MEMBERS)

#define FC_REFLECT_IMPL(TYPE, MEMBERS) FC_REFLECT_DERIVED_IMPL_EXT(TYPE, BOOST_PP_SEQ_NIL, MEMBERS)
